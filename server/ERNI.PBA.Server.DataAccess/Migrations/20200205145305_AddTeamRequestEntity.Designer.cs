...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ERNI.PBA.Server.DataAccess.Model.TeamRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ERNI.PBA.Server.DataAccess.Model.Request", b =>
                {
                    ...
                    b.HasOne("ERNI.PBA.Server.DataAccess.Model.TeamRequest", "TeamRequest")
                        .WithMany("Requests")
                        .HasForeignKey("TeamRequestId")
                        .OnDelete(DeleteBehavior.Cascade);
